    ...
    public class DataRow
    {
        ...
        public object this[int columnIndex]
        {
            get
            {
                ...
                if (columnName != null && this.RowObject.TryGetValue(columnName, out result)) return result;
                return string.Empty;
            }
            set
            {
                var columnName = RowObject.Keys.Skip(columnIndex).FirstOrDefault();
                if (columnName != null && RowObject.ContainsKey(columnName)) RowObject[columnName] = value;
